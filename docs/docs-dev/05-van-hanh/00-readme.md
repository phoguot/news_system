...
| `05-checklist-go-live.md` | Trước khi bật cho người dùng thật: 12 nhóm checklist (DB utf8mb4_0900_ai_ci + 18 bảng, tìm kiếm tiếng Việt, hẹn giờ ≤ 60s, auth, secret, uploads không thực thi được, SMTP + captcha, media, SEO/sitemap/robots, backup, kiểm cuối) + 7 điểm cần chốt |
